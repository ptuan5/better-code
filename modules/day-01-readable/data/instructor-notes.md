...
- `data/slide-outline.md`
- `data/folder-structure-demo.md`
- `data/activity-1-messy-directory.md`
- `data/activity-2-rewrite-code.md`
...
- Start with the messy tree in `data/folder-structure-demo.md`.
...
- Open `r/starter.R` or `python/starter.py` and read it once without editing.
