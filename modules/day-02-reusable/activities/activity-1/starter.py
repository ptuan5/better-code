...
liver_summary = (
    f'Liver strong genes = {len(liver_hits)} | top partner = {liver_top_gene} | '
...
adipose_summary = (
    f'Adipose Subcutaneous strong genes = {len(adipose_hits)} | top partner = {adipose_top_gene} | '
    f'average correlation = '
...
muscle_summary = (
    f'Muscle Skeletal strong genes = {len(muscle_hits)} | top partner = {muscle_top_gene} | '
    f'average correlation = '
